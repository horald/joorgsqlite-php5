...
while ($row = $results->fetchArray()) {
 ...
 //echo $sqlref."<br>";
  ...
  echo "<td><a href='mark.php?menu=".$menu."&menugrp=".$menugrp."&id=".$index."' class='btn btn-primary btn-sm active' role='button'>OK</a></td> ";
  echo "<td><a href='update.php?menu=".$menu."&menugrp=".$menugrp."&id=".$index."' class='btn btn-primary btn-sm active' role='button'>U</a></td> ";
  echo "<td><a href='delete.php?menu=".$menu."&menugrp=".$menugrp."&id=".$index."' class='btn btn-primary btn-sm active' role='button'>D</a></td>";
  echo "</tr>";
