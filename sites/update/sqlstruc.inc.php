...
'sql' => 'CREATE TABLE tbletagen (fldindex INTEGER PRIMARY KEY AUTOINCREMENT, fldbez TEXT)',
'column' => array('fldindex INTEGER PRIMARY KEY AUTOINCREMENT',' fldbez TEXT')),
array('tablename' => 'tblorte',
'sql' => 'CREATE TABLE tblorte (fldhoehe NUMERIC, fldbreite NUMERIC, fldykoor NUMERIC, fldxkoor NUMERIC, fldview TEXT, fldid_zimmer NUMERIC, fldindex INTEGER PRIMARY KEY, fldBez TEXT, fldo01typ TEXT)',
'column' => array('fldhoehe NUMERIC',' fldbreite NUMERIC',' fldykoor NUMERIC',' fldxkoor NUMERIC',' fldview TEXT',' fldid_zimmer NUMERIC',' fldindex INTEGER PRIMARY KEY',' fldBez TEXT',' fldo01typ TEXT')),
